...
var registerUser = express_async_handler_1["default"](function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, userExists, newUser;
            ...
            case 2:
                ...
                if (newUser) {
                    res.status(201).json({
                        ...
                        token: generateToken_1["default"](newUser._id)
                    });
                }
                else {
...
// @access Public
var loginUser = express_async_handler_1["default"](function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
// @access Private
var getUser = express_async_handler_1["default"](function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var deleteUser = express_async_handler_1["default"](function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userModel_1["default"].findByIdAndDelete(req.params.id)];
            case 1:
                user = _a.sent();
                if (user) {
